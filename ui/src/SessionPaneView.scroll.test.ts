// Owns scroll intent, input navigation and resident-history transition tests.
// Does not own observer/layout lifecycle or explicit history-boundary demands;
// those live in SessionPaneView.scroll-{observers,boundaries}.test.ts.
