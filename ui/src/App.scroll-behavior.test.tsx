...
// workspace-layout tests, session-lifecycle tests, or prompt-send/live-turn
// scroll integration (App.send-scroll.test.tsx).
//
...
import type { McpElicitationRequestMessage, Session } from "./types";
